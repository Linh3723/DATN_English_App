        ...
        child: Column(
          children: [
            ...
            if (course.requirements.isNotEmpty) ...[
              _buildSectionTitle(context, 'Kỹ năng cần thiết'),
              const SizedBox(height: 8),
              ...course.requirements.map(
                (requirements) => _buildRequirementItem(context, requirements),
              ),
              const SizedBox(height: 16),
            ],
            if (course.whatYouWillLearn.isNotEmpty) ...[
              _buildSectionTitle(context, 'Những gì bạn sẽ học được'),
              const SizedBox(height: 16),
